...
export function calculateSettlement(
  ...
  // Apply Tax Pipeline (18% Flat GST equivalent)
  const intTax = Math.round(intSubtotal * 0.18);
  
  // Aggregate Secure Integers
  const intGrandTotal = intSubtotal + intTax;
  ...
  return {
    ...
    taxAmount: intTax / 100,
    finalTotal: intGrandTotal / 100,
  };
}
